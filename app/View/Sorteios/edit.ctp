...
<?php echo $this->Form->create('Sorteio'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sorteio'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Sorteio.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Sorteio.id'))); ?></li>
